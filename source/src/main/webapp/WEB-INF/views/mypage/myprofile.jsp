						...
						<div id="profile_area">
							<div>
								<div id="profileImg_area">
									...
									<div>
										<button class="changeBtn" type="button" onclick="changeProfImg()">프로필 사진 변경</button>
									</div>
								</div>
								<div id="nameArea">
									<span>닉네임 : ${mypageMember.mname}</span>
									<button class="changeBtn" type="button" onclick="changeName()">닉네임 변경</button>
								</div>
								<div id="pwdArea">
									<button class="changeBtn" type="button" onclick="changePwd()">비밀번호 변경</button>
								</div>
								<div>
									<span>
										<a href="">회원 탈퇴</a>
